...
| :----| :----------------| :----------| :-------------------| :--------------------|
| 1    | -ZR-             | 13.9 TiB   | 11.6 TiB (83.39%)   | 177 (~80.3 GiB each) |
| 2    | sam              | 3.6 TiB    | 3.3 TiB (90.03%)    | 128 (~28.9 GiB each) |
| 3    | NAN0             | 3.3 TiB    | 3.2 TiB (97.73%)    | 48 (~70.8 GiB each)  |
...
| 12   | NOGRP            | 1.2 TiB    | 726.5 GiB (60.97%)  | 14 (~85.1 GiB each)  |
| 13   | LazyRemux        | 1.2 TiB    | 1.2 TiB (100.00%)   | 15 (~78.8 GiB each)  |
...
| 41   | UDF              | 454.9 GiB  | 191.5 GiB (42.10%)  | 20 (~22.7 GiB each)  |
| 42   | OZR              | 426.7 GiB  | 292.7 GiB (68.58%)  | 14 (~30.5 GiB each)  |
| 43   | FraMeSToR        | 378.4 GiB  | 378.4 GiB (100.00%) | 8 (~47.3 GiB each)   |
| 44   | VULCAN           | 360.8 GiB  | 360.8 GiB (100.00%) | 3 (~120.3 GiB each)  |
| 45   | FLE              | 349.8 GiB  | 330.0 GiB (94.34%)  | 8 (~43.7 GiB each)   |
| 46   | Pog42            | 347.5 GiB  | 188.4 GiB (54.20%)  | 25 (~13.9 GiB each)  |
| 47   | NH               | 342.2 GiB  | 85.5 GiB (24.99%)   | 19 (~18.0 GiB each)  |
| 48   | YURASUKA         | 325.3 GiB  | 15.4 GiB (4.72%)    | 31 (~10.5 GiB each)  |
| 49   | BiRJU            | 324.0 GiB  | 324.0 GiB (100.00%) | 4 (~81.0 GiB each)   |
| 50   | inid4c           | 321.5 GiB  | 0 B (0.00%)         | 6 (~53.6 GiB each)   |
| 51   | mofobunny        | 312.6 GiB  | 312.6 GiB (100.00%) | 1 (~312.6 GiB each)  |
| 52   | Aergia           | 304.3 GiB  | 304.3 GiB (100.00%) | 4 (~76.1 GiB each)   |
| 53   | Datte13          | 275.7 GiB  | 96.6 GiB (35.06%)   | 11 (~25.1 GiB each)  |
| 54   | Mysteria         | 271.3 GiB  | 175.9 GiB (64.84%)  | 18 (~15.1 GiB each)  |
| 55   | Pizza            | 268.4 GiB  | 197.9 GiB (73.74%)  | 7 (~38.3 GiB each)   |
| 56   | Legion           | 239.4 GiB  | 155.6 GiB (64.98%)  | 8 (~29.9 GiB each)   |
| 57   | HorribleSubs     | 237.0 GiB  | 27.4 GiB (11.55%)   | 13 (~18.2 GiB each)  |
| 58   | fig              | 235.5 GiB  | 235.5 GiB (100.00%) | 6 (~39.2 GiB each)   |
| 59   | Netaro           | 222.5 GiB  | 197.3 GiB (88.65%)  | 7 (~31.8 GiB each)   |
| 60   | ANE              | 220.9 GiB  | 120.3 GiB (54.48%)  | 11 (~20.1 GiB each)  |
| 61   | UQW              | 220.1 GiB  | 27.2 GiB (12.36%)   | 2 (~110.1 GiB each)  |
| 62   | Commie           | 213.6 GiB  | 0 B (0.00%)         | 30 (~7.1 GiB each)   |
| 63   | FFF              | 212.0 GiB  | 0 B (0.00%)         | 10 (~21.2 GiB each)  |
| 64   | Virtuality       | 205.2 GiB  | 166.6 GiB (81.20%)  | 4 (~51.3 GiB each)   |
| 65   | ASC              | 202.8 GiB  | 143.8 GiB (70.92%)  | 12 (~16.9 GiB each)  |
| 66   | Iznjie Biznjie   | 200.3 GiB  | 132.8 GiB (66.27%)  | 10 (~20.0 GiB each)  |
| 67   | Asakura          | 195.8 GiB  | 25.5 GiB (13.03%)   | 11 (~17.8 GiB each)  |
| 68   | Exp              | 191.8 GiB  | 108.7 GiB (56.64%)  | 11 (~17.4 GiB each)  |
| 69   | FateSucks        | 190.1 GiB  | 190.1 GiB (100.00%) | 4 (~47.5 GiB each)   |
| 70   | o7               | 185.3 GiB  | 56.0 GiB (30.25%)   | 13 (~14.3 GiB each)  |
| 71   | Hark0n           | 179.4 GiB  | 83.0 GiB (46.30%)   | 3 (~59.8 GiB each)   |
| 72   | PMR              | 177.7 GiB  | 177.7 GiB (100.00%) | 3 (~59.2 GiB each)   |
| 73   | AC               | 177.4 GiB  | 0 B (0.00%)         | 6 (~29.6 GiB each)   |
| 74   | CiNEPHiLES       | 176.6 GiB  | 152.3 GiB (86.21%)  | 4 (~44.2 GiB each)   |
| 75   | aRMX             | 171.7 GiB  | 171.7 GiB (100.00%) | 3 (~57.2 GiB each)   |
| 76   | GSK_kun          | 168.8 GiB  | 20.4 GiB (12.08%)   | 12 (~14.1 GiB each)  |
| 77   | Flugel           | 166.9 GiB  | 166.9 GiB (100.00%) | 6 (~27.8 GiB each)   |
...
| 90   | ABdex            | 134.8 GiB  | 134.8 GiB (100.00%) | 3 (~44.9 GiB each)   |
| 91   | cappybara        | 134.4 GiB  | 108.8 GiB (80.94%)  | 6 (~22.4 GiB each)   |
| 92   | derp             | 128.7 GiB  | 104.9 GiB (81.51%)  | 6 (~21.4 GiB each)   |
| 93   | ShadyCrab        | 126.7 GiB  | 26.5 GiB (20.89%)   | 5 (~25.3 GiB each)   |
| 94   | P9               | 123.6 GiB  | 123.6 GiB (100.00%) | 8 (~15.4 GiB each)   |
| 95   | RASETSU          | 123.5 GiB  | 19.7 GiB (15.93%)   | 6 (~20.6 GiB each)   |
| 96   | Baws             | 121.4 GiB  | 48.6 GiB (40.08%)   | 8 (~15.2 GiB each)   |
| 97   | Dragon-Releases  | 120.7 GiB  | 0 B (0.00%)         | 5 (~24.1 GiB each)   |
| 98   | Lv.99 Villain    | 118.7 GiB  | 118.7 GiB (100.00%) | 1 (~118.7 GiB each)  |
| 99   | sgt              | 118.5 GiB  | 108.3 GiB (91.36%)  | 5 (~23.7 GiB each)   |
| 100  | Others           | 13.2 TiB   | 6.8 TiB (51.22%)    | 854 (~15.8 GiB each) |
