...
- Total size: `123.6 TiB`
- Best size: `93.1 TiB`
- Alt size: `30.4 TiB`
- Realistic size: `96.2 TiB`
...
| 12   | MTBB             | 1.5 TiB    | 1.3 TiB (83.61%)    | 101 (~15.3 GiB each)  |
...
| 45   | BBT-RMX          | 532.1 GiB  | 374.5 GiB (70.37%)  | 10 (~53.2 GiB each)   |
...
| 50   | Others           | 38.6 TiB   | 21.5 TiB (55.78%)   | 1787 (~22.1 GiB each) |
