...
- Total size: `115.1 TiB`
- Best size: `86.1 TiB`
- Alt size: `29.0 TiB`
- Realistic size: `89.6 TiB`
...
| 3    | NAN0             | 6.4 TiB    | 6.3 TiB (98.82%)    | 86 (~76.3 GiB each)   |
...
| 21   | YURI             | 868.7 GiB  | 385.1 GiB (44.33%)  | 71 (~12.2 GiB each)   |
...
| 50   | Others           | 35.7 TiB   | 20.0 TiB (55.97%)   | 1714 (~21.3 GiB each) |
