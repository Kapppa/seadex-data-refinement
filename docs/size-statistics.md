...
- Total size: `103.5 TiB`
- Best size: `75.9 TiB`
- Alt size: `27.6 TiB`
- Realistic size: `79.9 TiB`
...
| 2    | CRUCiBLE         | 6.7 TiB    | 6.6 TiB (99.22%)    | 90 (~75.7 GiB each)   |
...
| 11   | SubsPlease       | 1.4 TiB    | 206.9 GiB (14.38%)  | 86 (~16.7 GiB each)   |
...
| 20   | KH               | 875.3 GiB  | 318.2 GiB (36.36%)  | 53 (~16.5 GiB each)   |
...
| 50   | Others           | 32.4 TiB   | 17.7 TiB (54.70%)   | 1654 (~20.0 GiB each) |
