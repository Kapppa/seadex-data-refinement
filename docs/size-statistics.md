...
- Total size: `106.2 TiB`
- Best size: `77.8 TiB`
- Alt size: `28.4 TiB`
- Realistic size: `82.1 TiB`
...
| :----| :----------------| :----------| :-------------------| :---------------------|
| 1    | -ZR-             | 14.6 TiB   | 12.3 TiB (84.36%)   | 186 (~80.4 GiB each)  |
| 2    | CRUCiBLE         | 7.4 TiB    | 7.4 TiB (99.30%)    | 98 (~77.4 GiB each)   |
...
| 50   | Others           | 33.2 TiB   | 18.3 TiB (55.20%)   | 1692 (~20.1 GiB each) |
