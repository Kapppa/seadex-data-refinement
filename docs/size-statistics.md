...
- Total size: `117.9 TiB`
- Best size: `88.6 TiB`
- Alt size: `29.3 TiB`
- Realistic size: `92.0 TiB`
...
| 2    | CRUCiBLE         | 10.4 TiB   | 10.4 TiB (100.00%)  | 140 (~75.8 GiB each)  |
...
| 35   | YURASUKA         | 681.1 GiB  | 154.3 GiB (22.66%)  | 60 (~11.4 GiB each)   |
...
| 50   | Others           | 36.2 TiB   | 20.5 TiB (56.62%)   | 1732 (~21.4 GiB each) |
